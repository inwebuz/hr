...
class Order extends Model
{
    ...
    public static function paymentMethods() {
        return [
            ...
            // static::PAYMENT_METHOD_CARD => __('main.payment_method_card'),
            ...
            // static::PAYMENT_METHOD_INTERNATIONAL_CARD => __('main.payment_method_international_card'),
            // static::PAYMENT_METHOD_ZOODPAY_INSTALLMENTS => __('main.payment_method_zoodpay_installments'),
            // static::PAYMENT_METHOD_INSTALLMENTS => __('main.payment_method_installments'),
        ];
    }

    public static function paymentMethodsDescriptions() {
        return [
            static::PAYMENT_METHOD_CASH => __('main.payment_method_cash_description'),
            // static::PAYMENT_METHOD_CARD => __('main.payment_method_card_description'),
            // static::PAYMENT_METHOD_UZCARD => __('main.payment_method_uzcard_description'),
            // static::PAYMENT_METHOD_HUMO => __('main.payment_method_humo_description'),
            static::PAYMENT_METHOD_PAYME => __('main.payment_method_payme_description'),
            static::PAYMENT_METHOD_CLICK => __('main.payment_method_click_description'),
            // static::PAYMENT_METHOD_APELSIN => __('main.payment_method_apelsin_description'),
            // static::PAYMENT_METHOD_INTERNATIONAL_CARD => __('main.payment_method_international_card_description'),
            // static::PAYMENT_METHOD_ZOODPAY_INSTALLMENTS => __('main.payment_method_zoodpay_installments_description'),
            // static::PAYMENT_METHOD_INSTALLMENTS => __('main.payment_method_installments_description'),
        ];
    }

    public static function phoneNumberRequiredPaymentMethods() {
        return [
            static::PAYMENT_METHOD_PAYME,
            static::PAYMENT_METHOD_CLICK,
        ];
    }
