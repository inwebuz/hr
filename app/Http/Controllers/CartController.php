...
class CartController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        return view('checkout', compact('breadcrumbs', 'shippingMethods', 'shippingMethod', 'cart', 'cartItems', 'checkoutAvailable', 'publicOfferPage', 'orderTypes', 'communicationMethods', 'address', 'isGift'));
    }
