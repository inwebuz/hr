                ...
                <div class="col-lg-20 col-12">
                    <aside class="sidebar sticky-top catalog-sidebar">
                        <form action="{{ $category->url }}" class="category-main-form filter-form">
                            ...
                            <x-sidebar-categories :active-category-id="$category->id" :category-id="$category->parent_id"></x-sidebar-categories>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="sidebar-nav__list mb-3">
                                    ...
                                    <li>
                                        <a href="{{ route('brand.category', [$brand->getTranslatedAttribute('slug') ?? $brand->slug, $category->getTranslatedAttribute('slug') ?? $category->slug]) }}">{{ $brand->getTranslatedAttribute('name') }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                                <a href="javascript:;" class="text-gray" data-toggle="more-link" data-max="520">
